      ...
      <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
        ...
        <div class="d-flex justify-content-center py-4">
          <a href="<?= base_url('/')?>" class="logo d-flex align-items-center w-auto">
            ...
            <span class="d-none d-lg-block text-center">Human Resources Information System</span>
          </a>
        </div><!-- End Logo -->
        ...
        <div class="credits">
          <a href="https://www.instagram.com/idhammansyah">Developed by Idham Mansyah Awwalu &copy; <?= date('Y') ?></a>
        </div>
